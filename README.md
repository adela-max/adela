[index.html](https://github.com/user-attachments/files/26589947/index.html)
<!DOCTYPE html>
<html lang="zh-TW">
<head>
<meta charset="UTF-8">
...
<section class="hero" id="home">
  ...
  <div class="hero-content">
    ...
    <h1>
      嗨，我是 Adela<br>
      <strong>讓每個網站，<br>都說對的故事。</strong>
    </h1>
    <p class="hero-desc">
      負責網站前期架構規劃、文案溝通優化，直至網站順利上線。<br>
      橫跨醫療、法律、美容、餐飲、工程等多元產業，陪伴品牌從零打造數位形象。
    </p>
    <div class="hero-cta">
  ...
  <div class="section-inner">
    <div class="about-grid">
      <div class="about-photo-wrap fade-in">
        ...
        <div class="about-photo-label">← 可替換為個人照片</div>
      </div>
      <div class="about-text fade-in fade-in-delay-1">
        <div class="section-label">About Me</div>
        <h2 class="section-title">用規劃與溝通，<br>讓網站真正發揮作用</h2>
        <p>我是 Adela，一位專注於網站規劃的 <strong>Website PM / Planner</strong>。從需求訪談、資訊架構設計、文案溝通確認，到最終網站上線品質把關，我全程參與每個環節。</p>
        <p>我相信一個好的網站不只是視覺漂亮——它需要<strong>清晰的架構邏輯</strong>、<strong>符合用戶需求的動線設計</strong>，以及能真正傳遞品牌價值的文案內容。</p>
        <p>迄今已協助 25+ 個品牌建立網路形象，橫跨診所、法律顧問、美容美髮、寵物、音響等多元產業。</p>
        <div class="about-tags">
          ...
          <span class="about-tag">GA4 數據分析</span>
        </div>
      </div>
    </div>
  </div>
...
const featured = [
  {
    ...
    work: ['進行需求訪談，釐清診所定位與目標客群','規劃 Sitemap 與頁面架構（首頁、關於、診療項目、醫師介紹、預約）','撰寫並優化各頁文案，確認醫師用語與品牌調性一致','協調設計師與工程師，確保視覺與架構符合需求','上線前品質把關，測試各頁功能與 RWD'],
  ...
  },
  {
    ...
    work: ['需求訪談，了解服務項目與目標客群（企業主、HR）','規劃服務頁面分類架構（勞資爭議、教育訓練、顧問方案）','協助文案方向，使法律術語更易讀易懂','確認 CTA 按鈕動線設計，引導訪客主動詢問','SEO 基本關鍵字建議（勞基法顧問、勞資爭議處理）'],
  ...
  },
  {
    ...
    work: ['深入了解精準醫療專業內容，整理可對外溝通的語言','規劃複雜頁面架構（概念說明、團隊、套餐、流程）','多次文案確認會議，確保醫療正確性與易讀性兼顧','協調醫院行政、醫師、設計師三方意見','上線前進行多裝置測試與內容校稿'],
  ...
  },
  {
    ...
    work: ['訪談醫師了解診所定位與主力療程（植牙、矯正、美白）','規劃療程分類架構，設計清晰的資訊層級','協助文案優化，讓醫療術語更平易近人','設計預約諮詢 CTA 動線','確認品牌色調與視覺風格方向'],
  ...
  },
  {
    ...
    bg: '💇', thumb: 'th-rose',
    background: '美髮沙龍希望建立官方網站取代口耳相傳，讓顧客可以線上了解設計師風格並預約。',
  ...
  },
  {
    ...
    work: ['課程分類架構規劃（實體課、線上課、企業課）','師資介紹頁面設計規劃','報名流程與 CTA 動線設計','文案確認，讓健康專業知識易於理解','SEO 基本關鍵字方向建議'],
